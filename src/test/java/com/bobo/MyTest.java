...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("/home/bobo/IdeaProjects/my_cloud/src/main/java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/bobo?serverTimezone=UTC")
                .setUsername("root").setPassword("zhao635481603");
        ...
        packageConfig.setParent("com.bobo.my_cloud").setMapper("mapper")
